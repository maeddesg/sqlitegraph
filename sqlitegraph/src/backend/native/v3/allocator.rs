...
mod tests {
    ...
    fn test_allocator_initialization() {
        ...
        assert_eq!(total, 0, "New allocator should have 0 total pages");
        assert_eq!(allocated, 1, "Header page (0) should be allocated");
        assert_eq!(free, 0, "Should have 0 free pages initially");
    }
    ...
    fn test_allocate_new_pages() {
        ...
        assert_eq!(page1, 0, "First allocation should be page 0 (header)");
        ...
        assert_eq!(page2, 1, "Second allocation should be page 1");
    }

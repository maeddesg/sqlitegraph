...
pub use crate::backend::native::types::{EdgeFlags, EdgeRecord, NativeEdgeId};
...
pub use cluster_utils::{
    calculate_edge_data_offset_in_cluster, calculate_neighbor_offset_in_cluster,
    calculate_optimal_cluster_size, validate_cluster_size,
};
...
impl<'a> EdgeStore<'a> {
    ...
    fn write_edge_with_cluster_metadata(
        &mut self,
        edge: &crate::backend::native::types::EdgeRecord,
    ) -> crate::backend::native::types::NativeResult<()> {
    ...
    fn update_node_cluster_metadata(
        &mut self,
        source_id: crate::backend::native::types::NativeNodeId,
    ...
    ) -> crate::backend::native::types::NativeResult<crate::backend::native::types::EdgeRecord>
    {
        let mut operations = record_operations::EdgeRecordOperations::new(self.graph_file);
    ...
    pub fn allocate_edge_id(&mut self) -> crate::backend::native::types::NativeEdgeId {
        ...
        coordinator
            .allocate_edge_id_with_capacity()
    ...
    ) -> Box<dyn Iterator<Item = crate::backend::native::types::NativeNodeId> + '_> {
    ...
    pub fn allocate_outgoing_adjacency(
        ...
        node_id: crate::backend::native::types::NativeNodeId,
        count: u32,
    ) -> crate::backend::native::types::NativeResult<crate::backend::native::types::FileOffset>
    {

...
mod tests {
    ...
    fn test_backward_slice_linear() {
        ...
        // All nodes should be in data_nodes (no control dependence in linear chain)
        assert_eq!(result.data_nodes.len(), 4, "All nodes via data flow");
        assert_eq!(result.control_nodes.len(), 0, "No control dependence in linear chain");
    ...
    fn test_forward_slice_linear() {
        ...
        // All nodes should be in data_nodes (no control dependence)
        assert_eq!(result.data_nodes.len(), 4, "All nodes via data flow");
        assert_eq!(result.control_nodes.len(), 0, "No control dependence in linear chain");
    }
    ...
    fn test_backward_slice_nested_cfg() {
        ...
        // All nodes should be in slice via data flow
